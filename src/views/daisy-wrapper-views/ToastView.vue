...
<template>
  <div class="container mx-auto p-8">
    ...
    <div class="space-x-2 mb-8">
      <button class="btn btn-success" @click="showToast('SUCCESS', 'File uploaded successfully!')">
        Show Success Toast
      </button>
      ...
      <button class="btn btn-ghost" @click="hideToast">
        Hide Toast
      </button>
    </div>

    <DaisyToast :toast-model="toastModel" />
  </div>
</template>
