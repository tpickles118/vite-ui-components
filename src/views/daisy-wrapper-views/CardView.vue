...
const productCard = ref(new CardModel({
  isBordered: true,
  shadow: CARD_OPTIONS.SHADOW.MD,
  width: CARD_OPTIONS.WIDTH.SM,
}));
    ...
    <section class="mb-8">
      ...
      >
        ...
        <div class="space-y-2">
          ...
          <div class="text-3xl font-bold text-primary">$29<span class="text-base font-normal">/month</span></div>
        </div>
